...
import 'package:flutter_smart_agriculture_system/core/network/dio_client.dart';
...
import 'package:flutter_smart_agriculture_system/features/auth/data/repositories/auth_repo_impl.dart';
import 'package:flutter_smart_agriculture_system/features/ai_detection/data/repositories/ai_detection_repo_impl.dart';
import 'package:flutter_smart_agriculture_system/features/dashboard/data/repositories/dashboard_repo_impl.dart';
import 'package:flutter_smart_agriculture_system/features/notifications/data/repositories/notifications_repo_impl.dart';
...
import 'package:flutter_smart_agriculture_system/features/dashboard/domain/usecases/get_farm_data_once.dart';
import 'package:flutter_smart_agriculture_system/features/dashboard/domain/usecases/watch_farm_data.dart';
import 'package:flutter_smart_agriculture_system/features/dashboard/domain/usecases/watch_logs.dart';
...
class AppDi {
  ...
  static WatchPumps provideWatchPumpsUsecase() {
    return WatchPumps(provideDashboardRepository());
  }

  static SetPumpAutoMode provideSetPumpAutoModeUsecase() {
    return SetPumpAutoMode(provideDashboardRepository());
  }

  static SetManualPumpState provideSetManualPumpStateUsecase() {
    return SetManualPumpState(provideDashboardRepository());
  }
